...
| **Experience Cloud + Agentforce embedded agent** | TODO — tried `sf.agentforce_experience_cloud.htm` (404) and Agentforce-for-Experience-Cloud slug variants; canonical Salesforce help slug for an Agentforce-embedded-on-Experience-Cloud article was not located in 3 attempts. Verify with current Agentforce documentation before any panel claim about embedded-agent capability inside an Experience Cloud site | (slug not located) | TODO — slug not located after 3 attempts |

...
|-------|------|-------------------|---------------|
| **Marketing Cloud editions — SFMC vs. Marketing Cloud Growth/Advanced** | These are different products with different roadmaps, different data models, and different feature sets — confirm which one the customer's deal is for before any commitment | https://www.salesforce.com/marketing/ | TODO — pinpoint specific edition page |
| **Sending limits and reputation** | Send-volume limits are tied to edition + IP reputation + sender authentication (SPF/DKIM/DMARC) — never quote raw send caps without context | https://help.salesforce.com/s/articleView?id=sf.mc_es_send_email_overview.htm | TODO — verify slug |
| **Compliance — CAN-SPAM / CASL / GDPR / TCPA** | Platform provides tools (preference centers, suppression lists, consent capture) but compliance is the customer's responsibility; the platform does not guarantee compliance | https://help.salesforce.com/s/articleView?id=sf.mc_overview_data_protection.htm | TODO — verify slug |
| **Journey Builder — entry sources and event triggers** | Journey Builder supports multiple entry sources (Data Extension, API event, schedule, Salesforce Audience); event-triggered journeys have specific latency characteristics — confirm before promising real-time | https://help.salesforce.com/s/articleView?id=sf.mc_jb_journey_builder.htm | TODO — verify slug |
| **Mobile / SMS — separate enablement** | SMS, MobilePush, WhatsApp, and other channels each have separate enablement, separate carrier relationships (for SMS), and separate compliance requirements | https://help.salesforce.com/s/articleView?id=sf.mc_moca_mobile_studio.htm | TODO — verify slug |
| **Marketing Cloud Personalization (formerly Interaction Studio)** | Separately licensed; personalization on web/mobile requires SDK implementation by the customer's web team | https://help.salesforce.com/s/articleView?id=sf.mc_pers_personalization.htm | TODO — verify slug |
| **Data Cloud + Marketing Cloud integration** | Data Cloud audiences can be activated in Marketing Cloud Growth/Advanced; legacy SFMC integration is via the Salesforce Audience connector with specific patterns and limits | https://help.salesforce.com/s/articleView?id=sf.c360_a_marketing_cloud_audiences.htm | TODO — verify slug |
| **API limits — REST and SOAP** | TODO — confirm current API call limits and rate-limit windows for the specific edition | https://developer.salesforce.com/docs/marketing/marketing-cloud/guide/index.html | TODO |
| **AMPscript / SSJS — execution context and limits** | TODO — document current limits and security boundaries | https://developer.salesforce.com/docs/marketing/marketing-cloud/guide/Personalization-Programming-Languages.html | TODO |

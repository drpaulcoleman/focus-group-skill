...
|-------|------|-------------------|---------------|
| **Government Cloud Plus — FedRAMP authorization** | FedRAMP **High** Provisional Authority to Operate (P-ATO) issued by the FedRAMP Joint Authorization Board (JAB). Annual independent evaluation per FedRAMP program requirements. The most recent FedRAMP package is request-only via a FedRAMP Package Access Request Form to the FedRAMP PMO. | https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/misc/government-cloud-plus-security-privacy-and-architecture.pdf | verified 2026-05-22 |
| **Government Cloud Plus — DoD Impact Level** | DoD Provisional Authorization (PA) **up to Impact Level 5 (IL5)** — covers IL2, IL4, and IL5 — issued by DISA per the DoD Cloud Computing Security Requirements Guide (CC SRG). **IL6 is not covered.** Government Cloud Plus - Defense is the SKU explicitly designed to store and process IL5 data including CUI and Unclassified National Security Information (U-NSI). | https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/misc/government-cloud-plus-security-privacy-and-architecture.pdf | verified 2026-05-22 |
| **Government Cloud Plus — StateRAMP / TX-RAMP** | TX-RAMP Level 2 Certification from the Texas Department of Information Resources (DIR) on the basis of the existing FedRAMP certification — listed as TX985547 on the TX-RAMP Certified Cloud Products list. **StateRAMP itself (the cross-state program) is not enumerated on the SPARC document** — TX-RAMP is the only state-level certification explicitly named. Verify other state-program reciprocity individually. | https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/misc/government-cloud-plus-security-privacy-and-architecture.pdf | verified 2026-05-22 |
| **Government Cloud Plus — IRS Pub 1075, CJIS, NIST 800-171, HITRUST** | IRS 1075 attestation (covers Federal Tax Information / FTI handling), CJIS (per the Salesforce compliance page, dated 2023-11-17), NIST SP 800-171 attestation (covers Controlled Unclassified Information / CUI handling), and HITRUST CSF Certification — all are held; attestation letters are request-only via the customer's Salesforce account executive. ITAR is **not** explicitly named in the Government Cloud Plus SPARC. | https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/misc/government-cloud-plus-security-privacy-and-architecture.pdf | verified 2026-05-22 |
| **Government Cloud Plus — feature parity gaps with commercial (HITRUST and PCI exclusions)** | The HITRUST CSF Certification for Government Cloud Plus excludes a long list of products: Salesforce CPQ and Billing, Consumer Goods Cloud, Manufacturing Cloud, Sustainability Cloud, Salesforce Connect, Salesforce Private Connect, Identity, Messaging, Salesforce Advisor Link, foundationConnect, Salesforce Maps, FSMP, Click FS Optimizer, Emergency Program Management, Public Sector Solutions, Salesforce Order Management, Accounting Subledger, Insights Platform, Nonprofit Cloud Case Management, Workplace Command Center, Shift Management, Employee Productivity, IT Service Center - IT Agent, Privacy Center, Service Cloud Voice, Grants Management, Intelligent Form Reader, Loyalty Cloud, Admissions Connect, and Student Success Hub. The PCI DSS Attestation of Compliance excludes a similarly long list. **Note: Public Sector Solutions itself is on the HITRUST and PCI exclusion lists** — surface this to the AO/InfoSec early. | https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/misc/government-cloud-plus-security-privacy-and-architecture.pdf | verified 2026-05-22 |
| **Government Cloud Plus — Agentforce / AI feature availability** | TODO — confirm Agentforce GA status and the specific Agentforce feature set in Government Cloud Plus against the most recent Salesforce release notes. The SPARC document does not enumerate Agentforce features; the Salesforce compliance index for Government Cloud Plus shows a generic "Chat with Agentforce" footer widget without committing to feature availability inside the FedRAMP boundary. Treat all Agentforce feature claims in Gov Cloud Plus as roadmap-class until validated against current release notes. | https://help.salesforce.com/s/articleView?id=release-notes.rn_overview.htm | TODO — verify against current release |
| **Government Cloud Plus — infrastructure** | Hosted on Amazon Web Services (AWS); FedRAMP High, DoD IL2, CJIS, and TX-RAMP entries on the Salesforce compliance index list AWS as the infrastructure. Some artifacts (e.g., the SPARC and Shield Platform Encryption Architecture) reference both AWS and Hyperforce. | https://compliance.salesforce.com/en/services/salesforce-government-cloud-plus-hyperforce | verified 2026-05-22 |
| **Government Cloud Plus — Setup Audit Trail and customer-accessible logs** | Certain administrative changes (password changes, custom field additions) are tracked in the Setup Audit Trail and viewable by the customer's system administrator; customers may download and store this data locally. System infrastructure and application logs are retained per FedRAMP requirements; logs are only accessible from within the GCP environment by Qualified US Citizens (US citizens, physically in the US, with a background check). For suspected inappropriate access, Salesforce can provide log entry records on a time-and-materials basis. | https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/misc/government-cloud-plus-security-privacy-and-architecture.pdf | verified 2026-05-22 |
...
Filling stubs is the cheapest accuracy lever this pack has. Government
Cloud Plus feature availability changes per release; re-verify against
the Salesforce release notes for any specific feature claim.
